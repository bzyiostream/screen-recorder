#ifndef RAY_THREADPOOL_H
#define RAY_THREADPOOL_H
...
public:
	...
	// bind£º .commit(std::bind(&Dog::sayHello, &dog));
	// mem_fn£º .commit(std::mem_fn(&Dog::sayHello), this)
